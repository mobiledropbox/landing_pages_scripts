...
// Hindi na ako gumamit ng plyr baka kung kailan capstone presentation doon hindi gumana.
document.addEventListener("DOMContentLoaded", () => {
    const vid = document.getElementById('player');
    if (vid) vid.controls = true;   // Native controls na lang.
...
async function fetchStars() {
    try {
        ...
        document.getElementById("starCount").textContent =
            `⭐ Repo stars earned: ${data.stargazers_count || 0}`;
    } catch (err) {
